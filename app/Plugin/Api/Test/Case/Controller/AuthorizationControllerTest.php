...
class AuthorizationControllerTest extends ApiBaseControllerTestCase {
	...
	* pois na classe só deverá tratar o ADD
	*/
	public function _testViewError(){
	...
	* pois na classe só deverá tratar o ADD
	*/
	public function _testEditError(){
		$this->validateTestException(
			$this->idURL,
			'PUT',
			$this->data,
	...
	* pois na classe só deverá tratar o ADD
	*/
	public function _testDeleteError(){
		$this->validateTestException(
			$this->idURL,
			'DELETE',
			$this->data,
	 ...
	 * a mensagem que usuário ou password não foram recebidos
	 */
	public function _testSemPassWord() {
		// Remove campo do array de envio
	 ...
	 */
	public function _testEquipamentoSemArea() {
	 ...
	 */
	public function _testEquipamentoSemAssociado() {
	 ...
	 */
	public function _testEquipamentoSituacaoDiferenteAtivo() {
	 ...
	 */
	public function _testSemOperador() {
	 ...
	 */
	public function _testFecharServicosAbertos() {
	 ...
	 * 
	 */
	public function _testCriarServicoNovo() {
	 ...
	 */
	public function _testCobrancaVinculada() {
		$this->testAction($this->fullURL, array('method' => 'POST', 'data' => $this->data));
	 ...
	 * @deprecated 
	 */
	public function _testSemParkSetor() {
	 ...
	 */
	public function _testRetornoEsperado() {
	 ...
	 * @return [type] [description]
	 */
	public function _testAtualizaRecibos() {
	 ...
	 * @return [type] [description]
	 */
	public function _testRetornoLeiautes() {
		// Salva um novo recibo
		$this->dataGenerator->saveRecibo();
		$this->dataGenerator->saveRecibo(array('Recibo' => array('leiaute_id' => 2)));
		$this->dataGenerator->saveRecibo(array('Recibo' => array('alvo' => 'POS')));
	 ...
	 */
	public function _testRegisterParquimetro() {
		// Seta os valores para os campos padrões
